...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		if (username.equals("Tommy124") && password.equals("12345")) {
		...
		// 10. Write a for loop that prints each number from 0 to 10
		System.out.println("\nLesson02 Question 10:");
		for (int i = 0; i < 10; i++) {
			System.out.println(i);
		}
		
		// 11. Write a for loop that prints each number from 10 to 0 backwards
		System.out.println("\nLesson02 Question 11:");
		for (int i = 10; i >= 0; i--) {
			System.out.println(i);
		}
